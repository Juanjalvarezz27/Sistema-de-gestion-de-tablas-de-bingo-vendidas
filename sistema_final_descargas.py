...
class SistemaGestionTablas:
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Sistema de Gestión de Tablas Vendidas")
        self.root.geometry("1000x800")
        self.root.configure(bg='#f8f9fa')
        
        # Archivo para guardar los datos
        self.data_file = "tablas_vendidas.json"
    ...
    def obtener_carpeta_descargas(self):
        ...
        try:
            ...
            if os.name == 'nt':
                ...
                downloads_path = os.path.join(documents_path, "Descargas")
                
                # Si no existe, usar una alternativa
            ...
            # Si hay error, usar la carpeta actual
    ...
    def crear_interfaz(self):
        ...
        # Título
        titulo = tk.Label(main_frame, text="🎫 SISTEMA DE GESTIÓN DE TABLAS VENDIDAS", 
    ...
    def crear_pestana_tablas(self, parent):
        ...
        self.btn_descargar_disponibles = tk.Button(controles_tablas_frame, 
                                                  ...
                                                  padx=15, pady=8, relief="raised", bd=2, cursor="hand2")
    ...
    def descargar_tickets_disponibles(self):
        ...
        try:
            ...
            ruta_completa = os.path.join(self.descargas_path, nombre_archivo)
